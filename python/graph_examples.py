...
def grid_example():
    ...
    for edge in graph.get_edges():
        plt.plot(
            [plot_points[edge[0]][0], plot_points[edge[1]][0]],
            [plot_points[edge[0]][1], plot_points[edge[1]][1]],
            "g-",
            linewidth=2,
        )
    ...
    ax.plot(
        [plot_points[start][0], plot_points[end][0]],
        [plot_points[start][1], plot_points[end][1]],
        "ro",
        markersize=4,
    )
    plt.show()
